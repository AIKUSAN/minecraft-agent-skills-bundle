...
- Added five advanced Minecraft administration/development skills: `minecraft-bedrock-server-admin`, `minecraft-bedrock-addon-dev`, `minecraft-resource-pack-conversion`, `minecraft-crossplay-ops`, and `minecraft-permissions-admin`
